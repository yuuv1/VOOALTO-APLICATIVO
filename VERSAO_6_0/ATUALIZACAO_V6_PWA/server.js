...
server.on('error',err=>{
  if(err.code==='EADDRINUSE'){
    ...
    console.log('  Feche a outra janela do Vooalto ou abra em outra porta:');
    console.log('     node server.js '+(PORT+1));
    console.log('');
  }else{
...
server.listen(PORT,'127.0.0.1',()=>console.log('Vooalto V6 em http://localhost:'+PORT));
